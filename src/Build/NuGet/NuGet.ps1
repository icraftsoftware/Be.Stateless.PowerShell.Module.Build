...
.EXAMPLE
    Find-NuGetPackageReference -Name Be.Stateless.Runtime
.EXAMPLE
    Find-NuGetPackageReference -Name Be.Stateless.Runtime -Version 2.0.21281.123
.EXAMPLE
    Find-NuGetPackageReference -Name Be.Stateless.BizTalk.*
.NOTES
    © 2021 be.stateless.
#>
